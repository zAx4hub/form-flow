...
> Self-host forms + spam + webhooks

**Author:** zAx4hub

## Problem

Teams need a practical open toolkit for: **Self-host forms + spam + webhooks**. Existing options are often closed SaaS or untested prototypes.

## Solution

`form-flow` is a complete, installable TypeScript/Node project by **zAx4hub** with real algorithms, CLI/demos, tests, and CI.
...
- Core engine for self-host forms + spam + webhooks
